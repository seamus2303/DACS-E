...
# require_once 'app/helpers/SessionHelper.php'; // Removed because file does not exist
...
// Thêm định tuyến cho api/user/create
if ($controllerName === 'ApiController' && isset($url[1]) && $url[1] === 'user' && isset($url[2]) && $url[2] === 'create') {
